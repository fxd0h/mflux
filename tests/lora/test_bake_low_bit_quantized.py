...
class _Fixtures:
    @staticmethod
    def quantized_base_with_small_adapter(bits: int):
...
def test_bake_into_q4_upgrades_to_q8_so_the_delta_survives():
    quantized, lora = _Fixtures.quantized_base_with_small_adapter(bits=4)
...
def test_bake_into_q8_preserves_the_base_precision():
    quantized, lora = _Fixtures.quantized_base_with_small_adapter(bits=8)
